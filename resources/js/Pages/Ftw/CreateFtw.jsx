...
export default function CreateFtw({ recommendations, canSelectEmployee }) {
    ...
    // ── Employee cache (populated as results load) ─────────────────────────
    ...
    const loadEmployees = useCallback(async (search, page) => {
        ...
        return {
            options: list.map((e) => ({
                ...
                label: `${e.employid} – ${e.emp_name}`, // full label used for dropdown search
            })),
    ...
    // Absence dates as Date[] for the calendar widget
